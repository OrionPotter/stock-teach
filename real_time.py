...
# 设置pandas显示选项，使数据更易读
pd.set_option('display.float_format', '{:.2f}'.format)  # 将浮点数格式化为两位小数
pd.set_option('display.max_columns', None)  # 显示所有列
pd.set_option('display.width', 1000)  # 加宽显示宽度，避免数据换行显示
pd.set_option('display.colheader_justify', 'center')  # 列标题居中显示
...
if __name__ == "__main__":
    # 获取并打印JSON结果
    json_result = get_stock_realtime_data("000895")
    print(json_result)
